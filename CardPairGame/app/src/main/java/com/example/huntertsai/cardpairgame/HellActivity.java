...
public class HellActivity extends AppCompatActivity {
    ...
    int[] cardArray = {101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210};
    ...
    private void frontOfCardResources() {
        ...
        image108 = R.drawable.hippopotamus;
        image109 = R.drawable.mouse;
        image110 = R.drawable.llama;
        ...
        image207 = R.drawable.squirrel_2;
        image208 = R.drawable.hippopotamus_2;
        image209 = R.drawable.mouse_2;
        image210 = R.drawable.llama_2;
    }
    ...
    private void checkIfPair() {
        if (firstCard == secondCard) {
            ...
            iv_41.setImageResource(R.drawable.cards);
            iv_42.setImageResource(R.drawable.cards);
            iv_43.setImageResource(R.drawable.cards);
            iv_44.setImageResource(R.drawable.cards);

            iv_51.setImageResource(R.drawable.cards);
            iv_52.setImageResource(R.drawable.cards);
            iv_53.setImageResource(R.drawable.cards);
            iv_54.setImageResource(R.drawable.cards);
    ...
    private void checkIfEnd(){
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(HellActivity.this);
            alertDialogBuilder
