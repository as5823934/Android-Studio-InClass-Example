...
public class TicTacToe_AI_Activity extends AppCompatActivity {
    ...
    private void playWithAI(HTextView cell, String content) {
    ...
    private void getAIMove(GameBoard board) {
        ...
        switch (move[0]) {
            case 0:
                switch (move[1]) {
                    case 0:
                        cell = findViewById(R.id.cell_11);
                        break;
                    case 1:
                        cell = findViewById(R.id.cell_12);
                        break;

                    case 2:
                        cell = findViewById(R.id.cell_13);
                        break;
                }
                break;
            case 1:
                switch (move[1]) {
                    case 0:
                        cell = findViewById(R.id.cell_21);
                        break;
                    case 1:
                        cell = findViewById(R.id.cell_22);
                        break;
                    case 2:
                        cell = findViewById(R.id.cell_23);
                        break;
                }
                break;
            case 2:
                switch (move[1]) {
                    case 0:
                        cell = findViewById(R.id.cell_31);
                        break;
                    case 1:
                        cell = findViewById(R.id.cell_32);
                        break;
                    case 2:
                        cell = findViewById(R.id.cell_33);
                        break;
                }
                break;
        }
        ...
        if (cell != null && cell.getText() == "") {
            ...
            final HTextView finalCell = cell;
            cell.postDelayed(new Runnable() {
                @Override
                public void run() {
                    finalCell.setAnimateType(HTextViewType.SCALE);

                    finalCell.animateText(aiMark);
